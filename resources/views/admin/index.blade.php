                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            @foreach ($reports as $report)
                                <div class="p-4 border rounded-lg shadow-sm">
                                    ...
                                    <p class="mb-3 text-sm text-gray-600">{{ Str::limit($report->description, 100) }}</p>
                                    <div class="flex justify-end">
                                        <a href="{{ route('admin.show', $report->id) }}" class="inline-flex items-center px-3 py-1 font-semibold text-gray-700 bg-gray-100 border border-transparent rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
